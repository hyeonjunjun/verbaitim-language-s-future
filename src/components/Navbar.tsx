  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 border-b border-border bg-background/80 backdrop-blur-md">
      <Container className="flex h-16 items-center justify-between">
        ...
        <button className="hidden md:flex items-center justify-center px-6 py-2 bg-signal text-white hover:bg-signal/90 transition-all rounded-full text-sm font-medium shadow-sm active:scale-95">
          Join the Beta
        </button>
